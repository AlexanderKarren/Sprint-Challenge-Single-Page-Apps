...
> Answer: In a website with a lot of pages that a user is expected to get through a lot of (ie documentation of some sort,) client-side-routing enables the user to experience one longer load time rather than a few short load times.
